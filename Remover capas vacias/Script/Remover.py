...
try:
    ...
    if admin_workspace_output == '':
        arcpy.AddMessage("\n*** No hay directorio de trabajo seleccionado\nSe limpiarán los features vacios de la base de datos: "+admin_workspace)
    ...
    arcpy.AddWarning("En esta versión esta herramienta borra únicamente Fetaure Dataset y Feature class de cualquier tipo de geometria con sus respectivas relaciones\n")
