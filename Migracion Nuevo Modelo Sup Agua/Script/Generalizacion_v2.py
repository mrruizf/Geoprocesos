...
def migraSuperficieHidrologia(featuresDataset,featureClass,temporal,foldersalida,nombregdb):
    ...
    if subcat ==0:
        ...
        return 3"""
                ...
                #arcpy.management.Append(featureClass, in_table, "NO_TEST", r'DIdentif "DIdentif" true true false 50 Text 0 0,First,#;DEstado "DEstado" true true false 2 Short 0 0,First,#,Drenaje_Sencillo,ESTADO_DRENAJE,-1,-1;DDisperso "DDisperso" true true false 50 Text 0 0,First,#,Drenaje_Sencillo,DISPERSION,0,1;DNombre "DNombre" true true false 255 Text 0 0,First,#,Drenaje_Sencillo,NOMBRE_GEOGRAFICO,0,255;RuleID "RuleID" true true true 4 Long 0 0,First,#;Override "Override" true true true 0 Blob 0 0,First,#,'+str(featureClass)+',Override,-1,-1', '', '')
                arcpy.management.Append(featureClass, in_table, "NO_TEST", r'DIdentif "DIdentif" true true false 50 Text 0 0,First,#;DEstado "DEstado" true true false 2 Short 0 0,First,#,Drenaje_Sencillo,ESTADO_DRENAJE,-1,-1;DDisperso "DDisperso" true true false 50 Text 0 0,First,#,Drenaje_Sencillo,DISPERSION,0,1;DNombre "DNombre" true true false 255 Text 0 0,First,#,Drenaje_Sencillo,NOMBRE_GEOGRAFICO,0,255;RuleID "RuleID" true true true 4 Long 0 0,First,#;Override "Override" true true true 0 Blob 0 0,First,#,Drenaje_Sencillo,Override,-1,-1', '', '')
                field = 'DEstado'
                expression = "clasificar(!DEstado!)"
                code_block = """def clasificar(subcat):
    if subcat ==5101:
        return 1
    elif subcat ==5102:
        ...
        return subcat"""
                arcpy.management.CalculateField(in_table,field,expression,"PYTHON3",code_block, "TEXT", "NO_ENFORCE_DOMAINS")
                field1 = 'DDisperso'
                expression1 = "clasifica(!DDisperso!)"
                code_block1 = """def clasifica(subcat):
    if subcat =='1':
        return 1
    elif subcat == '0':
        return 2"""
                arcpy.management.CalculateField(in_table,field1,expression1,"PYTHON3",code_block1)
                field2 = 'RuleID'
                expression2 = "modificar(!DEstado!,!DDisperso!)"
                code_block2 = """def modificar(estado,disperso):
    if estado == 2 and disperso == '2':
        return 1
    elif estado == 2 and disperso == '1':
        return 2
    elif estado == 1 and disperso == '2':
        return 3
    elif estado == 1 and disperso == '1':
        return 4
    else:
        return 5"""
                arcpy.management.CalculateField(in_table,field2,expression2,"PYTHON3",code_block2)
