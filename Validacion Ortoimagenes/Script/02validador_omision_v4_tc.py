...
#  areaomitidaoz = 10.1 if not args.areaomitidaoz else args.areaomitidaoz
#  directorioe = "C:\Excel.xls" if not args.directorioe else args.directorioe
#  escala = "1000" if not args.escala else args.escala
#  txtdrv = "C:\TxtDRV.txt" if not args.txtdrv else args.txtdrv
#  rutainct = "C:\Inconsistencias.shp" if not args.rutainct else args.rutainct
arcpy.CheckOutExtension("spatial")
#rutavectores = input("Indique la ruta donde se encuentran los archivos vectoriales: ") 
#namecloud = input("Indique el nombre de la capa de areas de nubes: ")
#areaomitidaoz = int(input("Indique el valor area omitida por otras zonas: "))
#directorioe = input("Indique el nombre del archivo de excel a diligenciar: ")
#escala = int(input("Indique la escala de trabajo de las imagenes: "))
#txtdrv = input("Indique ruta y nombre del archivo txt obtenido de DataReviewer: ")
#tmuestreo = int(input("Indique el tipo de muestreo para las medidas de inconsistencias (1-Total,2-Grilla): "))
#rutainct = input("Indique el nombre del archivo de Inconsistencias: ")

rutavectores = arcpy.GetParameterAsText(0)
txtdrv = arcpy.GetParameterAsText(1)
tmuestreo = arcpy.GetParameter(2)
