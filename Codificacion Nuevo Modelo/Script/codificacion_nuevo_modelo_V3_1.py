...
def codificacion(lista,gdb,CSV_STR):
    if len(lista)>3:
        for fc in lista:
...
try:
    ...
    codificacion(fcs,gdb,CSV_STR)
    codificacion(lista2,gdb,CSV_STR)
    codificacion(lista3,gdb,CSV_STR)
    codificacion(lista4,gdb,CSV_STR)
    codificacion(lista5,gdb,CSV_STR)
